  ...
  return <section className="py-20 px-6 bg-marsala">
      <div ref={ref} className={`container max-w-4xl mx-auto text-center scroll-reveal ${isVisible ? 'scroll-reveal-visible' : ''}`}>
        ...
        <p className="text-lg md:text-xl text-white leading-relaxed mb-12 max-w-3xl mx-auto">
          Cláudia Amin Mascarenhas e Lorena Amin Mascarenhas, advogadas especializadas em direito imobiliário e civil, com ampla experiência em assessoria para imobiliárias e condomínios. Uma advocacia com foco na área consultiva e preventiva.
        </p>

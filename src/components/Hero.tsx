...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="container max-w-5xl text-center space-y-8 relative z-10 -mt-32 md:-mt-48">
        ...
        <p className="text-base md:text-lg max-w-4xl mx-auto leading-relaxed opacity-95 mt-56 md:mt-72">
